      ...
      <div className="mx-auto max-w-[1120px] px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <a
            ...
            className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-mono tracking-wider text-neutral-900 hover:text-neutral-600 border border-black/[0.1] hover:border-black/[0.18] rounded-md transition-colors bg-white"
          >
            <span className="w-1.5 h-1.5 rounded-full bg-[#E0CE7A]" />
            Alquemia
          </a>
          <a
            href={`/${locale}/client`}
